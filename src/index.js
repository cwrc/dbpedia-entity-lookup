const findPerson = (queryString) => (
	callDBPedia(getPersonLookupURI(queryString), queryString, 'person')
)
const findPlace = (queryString) => (
	callDBPedia(getPlaceLookupURI(queryString), queryString, 'place')
)
const findOrganization = (queryString) => (
	callDBPedia(getOrganizationLookupURI(queryString), queryString, 'organisation')
)
